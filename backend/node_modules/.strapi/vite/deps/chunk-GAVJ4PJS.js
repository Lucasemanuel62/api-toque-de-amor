...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-3LINYTQB.js";
import {
  useConfig
} from "./chunk-NVYPLHS3.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-WNWXEIGF.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-MICQ7MVP.js";
import {
  renderAdmin
} from "./chunk-3BHNXGKW.js";
import {
  useLicenseLimits
...
import {
  Table,
  useTable
} from "./chunk-ZVDVXBSC.js";
import {
  useField,
  useForm
} from "./chunk-6PKV7MQE.js";
import {
  useRBAC
} from "./chunk-MCURRMZW.js";
import {
  require_omit
...
import {
  useTracking
} from "./chunk-LUSBPVDU.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
} from "./chunk-THT6UR75.js";
import {
  useAuth,
  useQueryParams
} from "./chunk-4PFTO6U5.js";
import {
  useNotification
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-XJF3SUE4.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-2H7BNFSW.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-3V5X52I4.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-IVAUWWVW.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-MK3FTBUJ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-DLZOKDSL.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-XRBHL237.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-4M2PYWY3.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-G32ON6VI.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-CNL3AEEH.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-FJS6BVOC.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-5RH5GAWR.js");
          return {
...
//# sourceMappingURL=chunk-GAVJ4PJS.js.map
